...
## 六、gulp常见任务
### 1. 处理js（包括转码、合并、压缩）  [gulp-babel](https://npm.taobao.org/package/gulp-babel) [babel-preset-es2015](https://npm.taobao.org/package/babel-preset-es2015) [gulp-concat](https://npm.taobao.org/package/gulp-concat) [gulp-uglify](https://npm.taobao.org/package/gulp-uglify)
...
### 7. debug  [gulp-print](https://npm.taobao.org/package/gulp-print)
...
### 11. 压缩css [gulp-minify-css](https://npm.taobao.org/package/gulp-minify-css)
...
### 12. 压缩图片 [gulp-imagemin](https://npm.taobao.org/package/gulp-imagemin)
...
### 13. 检查js  [gulp-jshint](https://npm.taobao.org/package/gulp-jshint)  [gulp-jshint](https://npm.taobao.org/package/jshint)
...
### 14. gzip压缩  [gulp-gzip](https://npm.taobao.org/package/gulp-gzip)
...
### 15. 处理前缀  [gulp-autoprefixer](https://npm.taobao.org/package/gulp-autoprefixer)
